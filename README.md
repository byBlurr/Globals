...
[LinkedIn Profile](linkedin.blurrdev.com) | 
[Fiverr Services](fiverr.blurrdev.com) | 
[Join Globals Server](globals.blurrdev.com) | 
[Invite Global Bot](globalbot.blurrdev.com)
...
In order for you to test Globals fully, you will need to be in atleast two servers with the bot invited. We haven't really made it to be self hosted, as it needs multiple servers using the same bot. You can obviously use the Globals server with your testing (globals.blurrdev.com). Any questions? Feel free to ask me @Blurr#3760 or ask for me in a global channel! This is a bot that benefits when there are more servers and more people using it. A week is a short time for building the population, but I hope you like what you see!
